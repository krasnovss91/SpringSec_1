...
<div align="center">
    ...
    <table bordercolor="red" border="1" cellpadding="4" cellspacing="0">
        ...
        <c:forEach var="user" items="${allUsers}">
            <tr>
                ...
                <td>
                    <a href="/jsp_project_war/update?id=<c:out value='${user.id}' />">Update this User</a>
                </td>
                <td>
                    <form method="POST" action="/jsp_project_war/delete?id=<c:out value='${user.id}' />">
    ...
    <div class="form-style-2">
        ...
        <form method="post" action="/jsp_project_war/create">
